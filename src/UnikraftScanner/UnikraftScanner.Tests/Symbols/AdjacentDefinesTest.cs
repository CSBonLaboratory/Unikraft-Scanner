...
public class AdjacentDefinesTest
{
    ...
    [Fact]
    public void TriggerStageAdjacentDefinesTest()
    {
        // we have an .o.cmd file but thte command is not for compilation using a known compiler but maybe other tool
        // return null
        ...
        BaseParsedCommandResult expected = new(
            includeTokens: [],
